...
The second section details DynaDA3-SLAM, a SLAM framework built upon DynaDA3 that leverages projective submap alignment and global optimization on the $SL(4)$/$Sim(3)$ manifold.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{DynaDA3}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Local Submap Generation with Motion Gating}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Submap Alignment via Projective Transformation}
