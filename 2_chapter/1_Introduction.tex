...
Section~\ref{sec:geometric_foundations} introduces the geometric foundations of 3D vision, common visual tasks, and the corresponding estimation and optimization algorithms.

Section~\ref{sec:dense_3d_theory} introduces learning-based dense 3D reconstruction technologies.
